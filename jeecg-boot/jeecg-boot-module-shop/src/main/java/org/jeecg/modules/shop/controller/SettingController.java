...
import org.jeecg.modules.shop.entity.Setting;
import org.jeecg.modules.shop.service.ISettingService;
...
public class SettingController extends JeecgController<Setting, ISettingService> {
	@Autowired
	...
	public Result<?> queryPageList(Setting setting,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<Setting> queryWrapper = QueryGenerator.initQueryWrapper(setting, req.getParameterMap());
		Page<Setting> page = new Page<Setting>(pageNo, pageSize);
		IPage<Setting> pageList = settingService.page(page, queryWrapper);
	...
	public Result<?> edit(@RequestBody Setting setting) {
  ...
  public ModelAndView exportXls(HttpServletRequest request, Setting setting) {
      return super.exportXls(request, setting, Setting.class, "系统参数");
  }
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      return super.importExcel(request, response, Setting.class);
  }
